...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency("activesupport", ">= 5.0.0.rc1", "5.0.0.rc2")
  spec.add_runtime_dependency("activerecord", ">= 5.0.0.rc1", "5.0.0.rc2")
  spec.add_runtime_dependency("argon2", "~> 1.1.0")
